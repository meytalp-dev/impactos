...
SYLLABLES = {
    ...
    "syl-av":    "אַב",
    "syl-ti":    "טִי",
    "syl-ach":   "אַח",  # פתח גנובה: אֲבַטִּיחַ נחתך אַב-טִי-אַח (לא חַ)
    "syl-ba":    "בָּ",
    "syl-na":    "נָ",
    "syl-nah":   "נָה",
    ...
    "syl-se":    "סֵ",
    "syl-fer":   "פֶר",
    "syl-sho":   "שֹׁ",  # חולם חסר — מונע אריכה של "שׁוֹו" ב-AvriNeural
    "syl-ko":    "קֹ",   # חולם חסר — מונע אריכה של "קוֹו"
    "syl-lad":   "לָד",
    "syl-me":    "מְ",
    "syl-ka2":   "קָ",
    "syl-rer":   "רֵר",
...
UI = {
    ...
    "ui-complete":       "הַבּוּעָה הִגִּיעָה לִפְנֵי הַמַּיִם. כֹּל הַכָּבוֹד!",
    "ui-complete-rise":  "הַבּוּעָה עָלְתָה! כֹּל הַכָּבוֹד.",
    "ui-complete-merge": "אָסַפְנוּ אֶת כֹּל הַחֲלָקִים! הַמִּלָּה שְׁלֵמָה.",
    "ui-count-question": "כַּמָּה חֲלָקִים שָׁמַעְתֶּם בַּמִּלָּה?",
    "ui-complete-count": "סָפַרְנוּ נָכוֹן! כֹּל הַכָּבוֹד.",
    "ui-choir-wake":     "הָעִירוּ אֶת הַמַּקְהֵלָה! לִחְצוּ עַל הַבּוּעוֹת בְּסֵדֶר.",
    "ui-complete-choir": "הַמַּקְהֵלָה שָׁרָה אֶת הַמִּלָּה! יָפֶה מְאוֹד.",
}
