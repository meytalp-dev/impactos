...
UI = {
    ...
    "ui-complete-rise":  "הַבּוּעָה עָלְתָה! כָּל הַכָּבוֹד.",
    "ui-complete-merge": "אָסַפְנוּ אֶת כָּל הַחֲלָקִים! הַמִּלָּה שְׁלֵמָה.",
    "ui-count-question": "כַּמָּה חֲלָקִים שָׁמַעְתֶּם בַּמִּלָּה?",
    "ui-complete-count": "סָפַרְנוּ נָכוֹן! כָּל הַכָּבוֹד.",
