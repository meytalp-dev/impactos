...
GAME_LINES = {
    "intro-twin-seaweeds":
        "בְּשׁוֹנִית הָאַצּוֹת, שְׁתֵּי אַצּוֹת זוֹהֲרוֹת עוֹמְדוֹת זוֹ לְצַד זוֹ. כָּל אַחַת שָׁרָה מִלָּה מִשֶּׁלָּהּ.",
    "intro-twin-mission":
    ...
    "twin-feedback-correct-same":
        "כֵּן! שְׁתֵּי הַמִּלִּים מַתְחִילוֹת בְּאוֹתוֹ צְלִיל. הִקְשִׁיבוּ:",
    "twin-feedback-correct-different":
        "כֵּן! הַצְּלִיל הָרִאשׁוֹן בִּשְׁתֵּי הַמִּלִּים שׁוֹנֶה. הִקְשִׁיבוּ:",
    "twin-and-the-other":
        "וְהַמִּלָּה הַשְּׁנִיָּה מַתְחִילָה בַּצְּלִיל",
    "twin-feedback-try-again":
        "כְּדַאי לְהַקְשִׁיב שׁוּב.",
    "twin-hint-listen-again":
        "הִקְלִידוּ עַל כָּל אַצָּה כְּדֵי לִשְׁמֹעַ אֶת הַמִּלָּה שׁוּב.",
