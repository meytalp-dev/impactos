...
GAME_LINES = {
    "intro-twin-seaweeds":
        "בְּשׁוֹנִית הָאַצּוֹת, זוּג אַצּוֹת זוֹהֲרוֹת עוֹמְדוֹת זוֹ לְצַד זוֹ. לְכָל אַחַת מִלָּה מִשֶּׁלָּהּ.",
    "intro-twin-mission":
        "הַמְשִׂימָה שֶׁלָּכֶם: לְהַקְשִׁיב לַמִּלִּים, וְלִקְבֹּעַ — הַאִם הַצְּלִיל הָרִאשׁוֹן זֵהֶה אוֹ שׁוֹנֶה.",
    "twin-question-same-or-different":
        "הַאִם הַצְּלִיל הָרִאשׁוֹן בַּמִּלִּים זֵהֶה אוֹ שׁוֹנֶה?",
    "twin-feedback-correct-same":
        "כֵּן! הַמִּלִּים מַתְחִילוֹת בְּאוֹתוֹ צְלִיל.",
    "twin-feedback-correct-different":
        "כֵּן! הַצְּלִילִים שׁוֹנִים.",
