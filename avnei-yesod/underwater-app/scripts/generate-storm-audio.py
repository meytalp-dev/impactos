...
STORM_LINES = {
    ...
    "intro-storm-quest":     "הָיְתָה סְעָרָה. גַּן הָאַלְמוּגִים חָשׁוּךְ. נוֹנִי עָצוּב.",
    ...
    "finale-storm-cleared":  "הַיָּם זוֹהֵר שׁוּב! יוֹפִי גָּדוֹל!",
    # ת׳ — המשחקון הפעיל
    "intro-storm-tav-quest":     "הָיְתָה סְעָרָה. גַּן הָאַלְמוּגִים חָשׁוּךְ. נוֹנִי עָצוּב.",
    ...
    "finale-storm-tav-cleared":  "הַיָּם זוֹהֵר שׁוּב! יוֹפִי גָּדוֹל!",
}
