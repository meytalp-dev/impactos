...
ITEMS = [
    ...
    # פינאלה — המרגלית מתגלה (גם מַרְגָּלִית מתחילה במם).
    (
        "finale-mem-cave",
        "הִדְלַקְתֶּם אֶת כֹּל הַצְּדָפִים! הַמְּעָרָה זוֹהֶרֶת — וּבִפְנִים מַרְגָּלִית נוֹצֶצֶת! "
        "גַּם מַרְגָּלִית מַתְחִילָה בָּאוֹת מֵם."
    ),
]
