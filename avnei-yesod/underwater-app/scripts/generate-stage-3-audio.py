...
FEEDBACK_LINES = {
    ...
    "right": "נָכוֹן",
    "press-here": "הַקִּישׁוּ פֹּה",
    "look-here": "הַבִּיטוּ פֹּה",
    "lets-find": "בּוֹאוּ נִמְצָא יַחַד",
    "great": "כֹּל הַכָּבוֹד",
    "stage-done": "סִיַּמְתֶּם אֶת הָאוֹת! מַמְשִׁיכִים",
    # לשון רבים (מיטל 8.7.2026: כל הפנייה לילד ברבים). "יְפֶהפֶה" הוחלף
    # 6.7.2026: שלוש גרסאות לסירוגין (מצוין/מעולה/נהדר)
    "all-done": "סִיַּמְתֶּם אֶת כֹּל הָאוֹתִיּוֹת. מְצֻיָּן",
    "all-done-2": "סִיַּמְתֶּם אֶת כֹּל הָאוֹתִיּוֹת. מְעֻלֶּה",
    "all-done-3": "סִיַּמְתֶּם אֶת כֹּל הָאוֹתִיּוֹת. נֶהְדָּר",
}
