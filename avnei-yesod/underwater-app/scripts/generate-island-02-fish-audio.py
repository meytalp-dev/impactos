...
GAME_LINES = {
    "intro-fish-schools":
        "בְּשׁוֹנִית הָאַצּוֹת חַיּוֹת שְׁתֵּי לְהָקוֹת דְּגִיגִים. כָּל לְהָקָה אוֹהֶבֶת צְלִיל אֶחָד.",
    "intro-fish-mission":
        "הַמְשִׂימָה שֶׁלָּכֶם: לְהַקְשִׁיב לְכָל דְּגִיג, וְלִשְׁלֹחַ אוֹתוֹ הַבַּיְתָה — לַלְּהָקָה שֶׁמַּתְחִילָה בְּאוֹתוֹ צְלִיל.",
    "fish-question-where-belongs":
        "לְאֵיזוֹ לְהָקָה שַׁיָּךְ הַדָּגִיג הַזֶּה?",
    "fish-feedback-correct":
        "כֵּן! הַדָּגִיג חָזַר הַבַּיְתָה.",
    "fish-feedback-try-again":
        "הַדָּגִיג עוֹד לֹא בְּמָקוֹם הַנָּכוֹן. כְּדַאי לְהַקְשִׁיב שׁוּב.",
    "fish-hint-listen-to-school":
        "הִקְלִידוּ עַל כָּל לְהָקָה כְּדֵי לִשְׁמֹעַ אֶת הַצְּלִיל שֶׁלָּהּ.",
    "fish-finale-complete":
        "כָּל הַדְּגִיגִים הִגִּיעוּ הַבַּיְתָה! בַּלְּהָקוֹת שָׂמֵחַ.",
}
