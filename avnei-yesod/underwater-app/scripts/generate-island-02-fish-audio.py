...
GAME_LINES = {
    "intro-fish-schools":
        "בְּשׁוֹנִית הָאַצּוֹת חַיּוֹת שְׁתֵּי לְהָקוֹת דְּגִיגִים. כֹּל לְהָקָה אוֹהֶבֶת צְלִיל אֶחָד.",
    "intro-fish-mission":
    ...
    "fish-finale-complete":
        "כֹּל הַדְּגִיגִים הִגִּיעוּ הַבַּיְתָה! בַּלְּהָקוֹת שָׂמֵחַ.",
}
