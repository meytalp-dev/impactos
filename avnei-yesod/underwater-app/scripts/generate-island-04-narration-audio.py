...
LINES = {
    ...
    'intro-isl04': (
        ...
        # "לְהִזָּכֵר" נהגה ע"י ה-TTS עם דגש בכ' (le-hizaKer) — הוחלף בניסוח בטוח
    ...
    # הוראות מכניקה (גנריות — לא פר אות) · לשון רבים (feedback-student-instructions-plural-form)
    'mission-isl04-cv-vs-cv': (
        "הַדָּג שׁוֹמֵעַ שְׁנֵי צְלִילִים — "
        "בַּחֲרוּ אֶת הַצְּלִיל הַנָּכוֹן שֶׁלּוֹ."
    ),
    'mission-isl04-tap-cv': (
        "הַדָּג מְחַפֵּשׂ אֶת הַצְּלִיל שֶׁלּוֹ — "
        "אִסְפוּ בִּשְׁבִילוֹ אֶת כֹּל הַצּוּרוֹת שֶׁל הַצְּלִיל הַזֶּה."
    ),
    'mission-isl04-listen-cv': (
        "הַדָּג שָׁר חַלָּשׁ. "
        "הַקְשִׁיבוּ לַצְּלִיל שֶׁלּוֹ — "
        "וְהַקִּישׁוּ עַל הַצּוּרָה הַנְּכוֹנָה."
    ),
    'mission-isl04-match': (
        "הַדָּג מְחַפֵּשׂ מִלָּה יְדִידָה שֶׁמַּתְחִילָה כָּמוֹהוּ. "
        "בַּחֲרוּ אֶת הַמִּלָּה הַנְּכוֹנָה."
    ),
}
