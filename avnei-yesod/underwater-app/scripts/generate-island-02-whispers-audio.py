...
GAME_LINES = {
    "intro-whispers":
        "בְּקַרְקָעִית הַיָּם שׁוֹכְבוֹת קוֹנְכִיּוֹת מִסְתּוֹרִיּוֹת. כָּל קוֹנְכִיָּה לוֹחֶשֶׁת מִלָּה.",
    ...
    "whispers-feedback-try-again":
        "בּוֹאוּ נִרְאֶה — אֵלוּ אוֹתוֹ צְלִיל בַּסּוֹף.",
    "whispers-hint-listen-to-ends":
        "הַקְשִׁיבוּ לַצְּלִיל שֶׁבַּסּוֹף שֶׁל כָּל מִלָּה.",
    "whispers-finale-complete":
        "כָּל הַצְּלִילִים נִפְגְּשׁוּ! יָם הַשְּׁמוּעוֹת שָׁקֵט וְזוֹהֵר.",
}
