...
HOUSE_LINES = {
    "intro-house-quest-bet":   "לְנוֹנִי אֵין אֵיפֹה לִישׁוֹן. עִזְרוּ לוֹ לִבְנוֹת בַּיִת מֵאַלְמוּגִים בְּצוּרַת הָאוֹת בֵּית.",
    "intro-house-mission-bet": "בּוֹאוּ נִפְתֹּר חָמֵשׁ חִידוֹת עַל הָאוֹת בֵּית — וְכָל פַּעַם תְּקַבְּלוּ לִבְנַת אַלְמוּג חֲדָשָׁה לַבַּיִת.",
    "finale-house-built":      "הַבַּיִת שֶׁל נוֹנִי מוּכָן! יוֹפִי גָּדוֹל!",
}
