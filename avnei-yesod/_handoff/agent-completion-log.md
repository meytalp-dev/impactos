...
## 🏗️ H7 — אי 7 · לגונת הזרמים (מעלית הצ׳אנקים) · אימות + חיווט תזמורת

**סטטוס:** ✅ done — אומת, חווט, נצרב. נותרו בלוח: H19 + R2 בלבד.
**תאריך:** 2026-07-08
**סוכן:** island-7-chunks (שלב-א af9359e · שלב-ב 2579275) · מאמת ומחווט: התזמורת

**תהליך דו-שלבי עבד:** רשימת 22 מועמדות עם אילוץ-תנועות-לפי-חודש → מיטל אישרה 14 (7.7) → נבנה. מכניקה חדשה mechanic-chunk-elevator (tap, לא drag) + 58 קליפי אודיו (QA Whisper: 14/14 מילים; 2 צ׳אנקים קצרים מדי לאימות-מכונה — ASK האזנה למיטל).

**מה אומת (עצמאית — אין spec committed):** 2 השלמות-מילה מלאות ב-Playwright: אירועים primary_island_id=7, is_correct, attempts; זהות-המילה ב-item_id (target_word אינו שדה בסכימה — כמו איים 6/20; הדיווח של הסוכן ניסח לא מדויק אך הנתונים תקינים). קונסולה נקייה · אריחי-צ׳אנק ~85px · שונית+נוני+ניקוד בדף-האי.

**חיווט:** צומת 7 נפתח — **18 איים פתוחים במפה** (הכול חוץ מ-19). תוכנית (2 ימים, אומת ב-diff): 'קריאת מילה ארוכה' (ינו׳) + 'קריאת מילים ארוכות' (אפר׳) → מעלית הצ׳אנקים.

**ASK קטן:** האזנה ל-2 קליפי הצ׳אנקים תַּ/פָּ (קצרים מדי לאימות-Whisper; מילות-האם שלהם עברו). **עתידי:** מעלית-4-קומות למילות הבונוס.

---

## ⛓️ N16 + H21 — אי 16 (שרשור פסקה) ואי 21 (דיקטה בבנייה) · אימות + חיווט תזמורת

**סטטוס:** ✅ done שניהם — אומתו, חווטו, נצרבו. נותרו בלוח: H7, H19, R2.
**תאריך:** 2026-07-07
**סוכנים:** island-16-paragraph-build (f068315) · island-21-dictation (5d2d247, תוכן אושר f3dffa9) · מאמת ומחווט: התזמורת

**מה אומת:** אי 16 — 10/10 (22-island16.spec.js): שרשור 3 משפטים *כתובים* בלי הקראה (ההיפוך מ-story-sequence), primary=16 + isl16-para-*. אי 21 — 8/8 (24-island21-dictation.spec.js): בניית משפט משמיעה, שני צירי-כישלון (סדר-מילים מול בחירת-מילה), primary=21, בנק המשפטים אושר פדגוגית ע"י מיטל לפני הצריבה. שניהם: specs committed ✓ + אימות עצמאי של דפי-האי.

**חיווט:** צמתים 16 + 21 נפתחו — **17 איים פתוחים במפה**. תוכנית (4 ימים, אומת ב-diff):
- 'רצף אירועים בסיפור' (מאי) → שרשרת משפטים אי 16 (בא אחרי קריאת "יום שוק" — קריאה, לא האזנה).
- 'הרכבת משפט מסדר מילים' (דצמ׳) → דיקטה בבנייה אי 21 (היה word-merge — התאמה שגויה).
- תיקון-מודליות: 'שאלות מי/מה/איפה' (מרץ) + 'שאלות הבנה (מי/מה/איפה)' (יוני) עברו מ-listen-and-answer ל-read-and-answer — ימים על טקסט נקרא. 'שאלות מי/מה על הנשמע' (נוב׳) נשאר האזנה.

**ASK פתוח למיטל (N16):** אישור 3 סטים נוספים לשרשור (built:false, לא מוצגים לילד): 'הַצֶּדֶף הַסָּגוּר' · 'הַדָּג שֶׁאָבַד' · 'הַשּׁוּנִית הַנְּקִיָּה'.
**משימת-עתיד:** מיפוי-תוויות ל-isl16-para-* / isl21-* בדשבורד המורה (מצטרף ל-isl11-*).

---

## 📖 C10b + N15 — השלמת אי 10 (זכר/נקבה + ה׳ הידיעה) ואי 15 (הבנת משפט) · אימות + חיווט תזמורת

**סטטוס:** ✅ done שניהם — אומתו, חווטו, נצרבו
**תאריך:** 2026-07-07
**סוכנים:** island-10b-gender-hey · island-15-sentence-comprehension · מאמת ומחווט: התזמורת

**מה אומת:** C10b — 16/16 (22-island10b.spec.js) כולל two-tap ו-QA שה' מובחנת באוזן (הַדָּג/דָּג accept-sets נפרדות); דף אי 10 עם 4 כרטיסים. N15 — 14/14 (22-island15.spec.js) כולל אימות אין-הקראה-אוטומטית (הילד קורא לבד); בריצה הראשונה כשל-תשתית בודד של Playwright (כותרת-בדיקה דינמית עם מונה-סבבים משתנה — "Test not found in worker"); ריצה חוזרת 7/7 ✓. ⚠️ לקח לסוכני-spec: לא לשים ערכים דינמיים בכותרות בדיקות.

**חיווט:** צומת 15 נפתח (15 איים במפה). תוכנית (5 ימים, אומת ב-diff): 'בחירת משפט לאיור/לתמונה' ×3 → mode=image · 'הבנת משפט כן/לא' (נוב׳) → mode=question · 'זוגות זכר/נקבה' (דצמ׳) → הוּא אוֹ הִיא. ימי "שאלות מי/מה/איפה" (מרץ/יוני) = הבנת-פסקה — הושארו במכוון לאי 16. לה׳ הידיעה אין יום-תוכנית (נגיש מדף-האי).

**✅ אושר פדגוגית (מיטל, 7.7.2026):** כל טקסטי הפריטים של C10b — 6 זוגות התואר (כַּדּוּר/בֻּבָּה/כֶּלֶב/צִפּוֹר/סֵפֶר/עֻגָּה × גָּדוֹל/קָטָן/יָפֶה/חָדָשׁ) + 5 משפטי ה' הידיעה. אי 10 סגור לחלוטין — 4 משחקונים, כל ה-ASK סגורים.

---

## 🐟 N6 + N20 — אי 6 (שטף מילה) ואי 20 (איות פונולוגי) · אימות + חיווט תזמורת

**סטטוס:** ✅ done שניהם — אומתו, חווטו, נצרבו. גל 2 (N) יצא לדרך עם שני הראשונים.
**תאריך:** 2026-07-07
**סוכנים מבצעים:** island-6-word-fluency (c9a839e) · island-20-word-spell (b8f9f5d) · מאמת ומחווט: התזמורת

**מה אומת:** אי 6 — 20/20 ירוקים (23-island6.spec.js): flash-word עם response_time_ms, טעות-לא-מכשילה, repeat-fish עם occurrence. אי 20 — 6/6 (22-island20-spell.spec.js): הרכבה-משמיעה, מסיח נשאר במאגר. שניהם: אימות עצמאי של דפי-האי (קונסולה נקייה, שונית+נוני+ניקוד). שני הסוכנים צירפו specs ✓.

**חיווט:** צמתים 6 + 20 נפתחו במפה (14 איים פתוחים). תוכנית: 'קריאת מילים שלמות' (נוב׳) + 'התאמת מילה לתמונה (מהירות)' (מרץ) → דָּג מָהִיר (אומת ב-diff: 2 ימים בלבד). אי 20 — אין יום מתאים (כל ימי הכתיבה = מחברת בכוונה) → ASK למיטל.

**ASK — כולם נסגרו (7.7):** מיטל אישרה הכול — 18 מילות-העוגן + ניסוח הפידבק (אי 6) · tap-to-place + 6 מילים + תת-כותרת (אי 20) · 'כתיבת מילים קצרות + סיכום' (נוב׳) הפך מיום-מחברת לאי 20 (אומת ב-diff: יום אחד בלבד). שני האיים סגורים לחלוטין.
...
**ASK — נסגרו (7.7):** מיטל אישרה את שניהם (זכר/נקבה + ה' הידיעה) → נוספה משימת-המשך **C10b** ללוח עם פרומפט מלא (2 משחקונים, תוכן inline, spec חובה ב-commit, טקסטים לאישור פדגוגי ב-notes).
