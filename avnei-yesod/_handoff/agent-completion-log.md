...
**ממתין לאישור פדגוגי של מיטל (C10b):** טקסטי הפריטים החדשים — זוגות תואר (כַּדּוּר/בֻּבָּה/כֶּלֶב/צִפּוֹר/סֵפֶר/עֻגָּה × גָּדוֹל/קָטָן/יָפֶה/חָדָשׁ) + 5 משפטי ה' הידיעה (נוני רָאֲתָה אֶת הַדָּג · הַכֶּלֶב רָץ עַל הַחוֹל · הַיֶּלֶד קָפַץ לַמַּיִם · קָרָאתִי אֶת הַסֵּפֶר · הַשֶּׁמֶשׁ זָרְחָה בַּבֹּקֶר).
