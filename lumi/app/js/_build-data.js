...
['t3-emotions.json', 't4-colors.json', 't5-numbers.json', 't6-actioninstruction.json', 't7-greetingsfriends.json', 't8-fruits.json', 't10-face.json', 't12-family.json'].forEach((f) => {
