...
> **סטטוס נוכחי:** המשחקון **בר־בדיקה עכשיו** עם placeholder אמוג׳י/צללית (🦁🐘🐵🐻). האיורים והרקע כאן הם ה־ASK — עד שינחתו, ה־gradient של הסצנה + אמוג׳י ממלאים את מקומם. **אל תבנו פוליש חזותי לפני אישור המכניקה** (אושרה).
...
## ✅ צ'קליסט מסירה
- [ ] 4 × animals/wild/*.png (סט אחיד, רקע שקוף אמיתי אחרי rembg, ניגוד גודל פיל/קוף)
- [ ] 1 × worlds/safari/backgrounds/jungle-bg.png (אנכי, מרכז פתוח, לילה־חם לא מפחיד)
