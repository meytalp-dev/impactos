...
| [`pulse-system-handoff.html`](pulse-system-handoff.html) | **המסמך המסכם לטליה** — דף אחד עם 2 חלקים: (1) מדריך מלא — קהלים, תדירויות, כניסה, פולסים, דשבורדים, התערבויות, תרחישים, פרטיות, השקה (2) המערכת החיה — כפתורי כניסה לכל המסכים האמיתיים, walkthrough של "איך להתחיל פיילוט מחר בבוקר" ב-8 שלבים. |
