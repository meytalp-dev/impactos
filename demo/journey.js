/* ============================================================
   ...
   Focus child: איתי כ. · א'2  (reading: confuses sounds · pulse: drop in joy)
...
(function () {
  ...
  var STEPS = [
    ...
    { key: 'teacher-avnei.html', role: 'מורה',
  ...
  if (Object.prototype.hasOwnProperty.call(EXCURSIONS, file)) {
    ...
    es.textContent =
      ...
      'background:rgba(15,117,139,.96);color:#fff;border:none;border-radius:999px;padding:9px 16px;' +
      'font:800 13px Heebo,Arial,sans-serif;cursor:pointer;box-shadow:0 8px 22px -8px rgba(15,117,139,.8);' +
      'backdrop-filter:blur(4px);}' +
      '.jw-back:hover{background:#0c6478;} .jw-back .x{font-size:15px;}';
  ...
  css.textContent = [
    ...
    '.jw-brand{display:flex;align-items:center;gap:8px;font-weight:800;color:#0F758B;font-size:14px;white-space:nowrap;}',
    '.jw-brand .d{width:9px;height:9px;border-radius:3px;background:#0F758B;}',
    ...
    '.jw-chip.on{color:#0F758B;background:#E7F2F4;border-color:#BfE0E6;}',
    '.jw-chip.on .n{background:#0F758B;}',
    '.jw-chip.done{color:#4F9A4A;background:#EAF4EA;border-color:#CFE9DA;}',
    '.jw-chip.done .n{background:#4F9A4A;}',
    ...
    '.jw-call .role{display:inline-flex;align-items:center;gap:7px;font-size:11.5px;font-weight:800;color:#0F758B;',
      'background:#E7F2F4;border-radius:999px;padding:3px 11px;margin-bottom:9px;}',
    '.jw-call h4{font:800 19px Heebo,Arial;color:#15324A;margin:0 0 6px;}',
    '.jw-call p{font:500 13.5px/1.55 Heebo,Arial;color:#4A5E6A;margin:0 0 13px;}',
    ...
    '.jw-act{display:flex;align-items:center;gap:7px;flex:1;min-width:160px;text-decoration:none;background:#F4FAFB;',
      'border:1px solid #DCEAEC;border-radius:11px;padding:10px 13px;font:700 13px Heebo,Arial;color:#15324A;transition:background .2s;}',
    '.jw-act:hover{background:#E7F2F4;} .jw-act .ai{font-size:16px;} .jw-act .ag{margin-inline-start:auto;color:#0F758B;font-weight:800;}',
    '.jw-row{display:flex;align-items:center;gap:10px;}',
    '.jw-next{flex:1;display:flex;align-items:center;justify-content:center;gap:8px;background:#0F758B;color:#fff;',
      'border:none;border-radius:10px;padding:12px 18px;font:800 14.5px Heebo,Arial;cursor:pointer;transition:background .2s;}',
    '.jw-next:hover{background:#0c6478;}',
    '.jw-focus{outline:3px solid #0F758B!important;outline-offset:3px;border-radius:14px;',
      'box-shadow:0 0 0 6px rgba(15,117,139,.15)!important;scroll-margin:120px;transition:outline .3s;}',
  ...
  var chips = STEPS.map(function (s, k) {
    ...
    var mark = k < idx ? '✓' : (k + 1);
    return '<span class="jw-chip ' + cls + '"><span class="n">' + mark + '</span>' + s.role + '</span>';
  ...
  call.innerHTML =
    '<span class="role"><span style="width:7px;height:7px;border-radius:2px;background:#0F758B;display:inline-block;"></span>' +
